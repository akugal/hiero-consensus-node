...
/**
 * A {@link DataPointSnapshot} that contains a set of states represented as a double value,
 */
public interface StateSetDataPointSnapshot<E extends Enum<E>> extends DataPointSnapshot {
     ...
     * The order of states in the array corresponds to the order of boolean values returned by {@link #state(int)}.
     *
