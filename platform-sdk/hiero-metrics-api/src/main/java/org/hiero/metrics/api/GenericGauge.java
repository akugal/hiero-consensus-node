...
public final class GenericGauge<T, V>
        extends StatefulMetric<GaugeDataPoint<T, V>>
        implements GaugeDataPoint<T, V> {
    ...
    public static Builder<String, String> infoBuilder(String name) {
        return new Builder<String, String>(name)
                .withValueConverter(String.class, Function.identity());
    }

    public static <E extends Enum<E>> Builder<E, String> enumBuilder(String name) {
        return new Builder<E, String>(name)
                .withValueConverter(String.class, Enum::name);
    }
    ...
    public static Builder<Duration, Double> durationBuilder(String name, ChronoUnit unit) {
        ...
        return new Builder<Duration, Double>(name)
                .withValueConverter(Double.class,
                        duration -> (double) (duration.toNanos() / unit.getDuration().toNanos()));
    }
    ...
    public static class Builder<T, V> extends StatefulMetric.Builder<GaugeDataPoint<T, V>, Builder<T, V>, GenericGauge<T, V>> {
