...
import static com.swirlds.merkledb.MerkleDbMetricsRegistrationProvider.*;
...
public class MerkelDbMetrics {
    ...
    public static class CompactionStat {
        ...
        public CompactionStat(
            ...
            fileSize = registry.getMetric(fileSizeKey);
        }
    ...
    public static class StoreFileStat {
        ...
        private final LongGauge.Measurement offHeapHashesListSize;
        ...
        public StoreFileStat(MetricRegistry registry) {
            ...
            offHeapHashesListSize =
                    registry.getMetric(METRIC_KEY_OFFHEAP_HASHES_LIST).getOrCreateNotLabeled();
        ...
        private void updateOffHeapStats(final MerkleDbDataSource dataSource) {
            updateOffHeapStat(dataSource.getPathToDiskLocationInternalNodes(), offHeapHashesIndexSize::set);
            ...
            updateOffHeapStat(dataSource.getHashStoreRam(), offHeapHashesListSize::set);
        }
        ...
        private long updateHashesStoreFileStats(final MerkleDbDataSource dataSource) {
            final FileStatisticAware hashStoreDisk = dataSource.getHashStoreDisk();
            if (hashStoreDisk != null) {
                final LongSummaryStatistics hashFileStats = hashStoreDisk.getFilesSizeStatistics();
